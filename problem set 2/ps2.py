...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        been cleaned.
        """
        # run getNewPosition to retrieve new position
        newPos = self.pos.getNewPosition(self.d, self.speed)
        # test that new position is in the room
        # if yes then set new position and clean tile
        # if no then set new random direction
