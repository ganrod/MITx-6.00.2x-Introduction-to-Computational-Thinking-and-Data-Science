...
def readCityData(fName, scale = False):
    ...
    dataFile = open(r'D:\6.00.2x\Files\ProblemSet6\ProblemSet6\cityTemps.txt', 'r')
    numFeatures = 0
...
def test():
    points = buildCityPoints('D:\6.00.2x\Files\ProblemSet6\ProblemSet6\cityTemps.txt', False)
    #hCluster(points, Cluster.singleLinkageDist, 10, False)
    #points = buildCityPoints('D:\6.00.2x\Files\ProblemSet6\ProblemSet6\cityTemps.txt', True)
